...
using PyrotechnicShop.WebUI.Infrastructure.Concrete;

namespace PyrotechnicShop.WebUI.Infrastructure
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        {
            kernel.Bind<IPyrotechnicsRepository>().To<EFPyrotechnicsRepository>();
